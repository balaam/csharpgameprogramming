...
namespace Chapter11_4
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeTextures()
        {
            ...
            _textureManager.LoadTexture("start", "start.tga");
            _textureManager.LoadTexture("finish", "finish.tga");
            _textureManager.LoadTexture("sky", "sky.tga");
            _textureManager.LoadTexture("wall", "wall.tga");
        }
